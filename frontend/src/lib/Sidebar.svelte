...
<nav class="sidebar-nav">
  <div class="nav-group">
    <button type="button" class="nav-item" class:active={view === 'dashboard'} on:click={() => navigate('dashboard')}>
    ...
    <button type="button" class="nav-item" class:active={view === 'inventory'} on:click={() => navigate('inventory')}>
    ...
    <button type="button" class="nav-item" class:active={view === 'mobile'} on:click={() => navigate('mobile')}>
      ...
      <span class="nav-label">Mobile Devices</span>
    </button>

    <div class="nav-group-title">Operations</div>
    
    <button type="button" class="nav-item" class:active={view === 'support_board'} on:click={() => navigate('support_board')}>
      ...
      <span class="nav-label">Support Board</span>
    </button>
    <button type="button" class="nav-item" class:active={view === 'support_entry'} on:click={() => navigate('support_entry')}>
      ...
      <span class="nav-label">Support Entry</span>
    </button>
    <button type="button" class="nav-item" class:active={view === 'support_exit'} on:click={() => navigate('support_exit')}>
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg>
      <span class="nav-label">Support Exit</span>
    </button>
    <button type="button" class="nav-item" class:active={view === 'entry_hardware'} on:click={() => navigate('entry_hardware')}>
      ...
      <span class="nav-label">New Hardware</span>
    </button>
    <button type="button" class="nav-item" class:active={view === 'entry_mobile'} on:click={() => navigate('entry_mobile')}>
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14M5 12h14"/></svg>
      <span class="nav-label">New Mobile</span>
    </button>
    <button type="button" class="nav-item" class:active={view === 'assignments'} on:click={() => navigate('assignments')}>
...
<style>
  ...
  .nav-item:hover {
    ...
    color: var(--color-primary);
    border-color: rgba(245, 103, 26, 0.1);
  }
  ...
  .nav-item.active {
    ...
    color: var(--color-primary);
    border-color: rgba(245, 103, 26, 0.2);
    font-weight: 600;
  }
